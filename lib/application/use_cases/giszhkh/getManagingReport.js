...
async function getManagingReport(serviceLocator, { residentProfileId, periodId }) {
  const {
  ...
  try {
    ...
    const managingReport = await reformaZhkhExternal
      .getManagingReport({ login, password }, {
        reporting_period_id: periodId,
        house_id: currentHouse.house_id,
      });

    return managingReport;
  } catch (e) {
...
module.exports = getManagingReport;
