...
const edsEmergencyShutdownNotification = async (serviceLocator, data) => {
  ...
  const sendData = {
    userId,
    body,
    type: notificationEnum.EDS_EMERGENCY_SHUTDOWN,
    ...data,
  };
  try {
...
module.exports = edsEmergencyShutdownNotification;
